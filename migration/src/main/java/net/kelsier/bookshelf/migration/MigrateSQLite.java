...
import net.kelsier.bookshelf.api.db.dao.link.BookAuthorLinkDAO;
import net.kelsier.bookshelf.api.db.dao.BookDAO;
import net.kelsier.bookshelf.api.db.dao.link.BookLanguageLinkDAO;
import net.kelsier.bookshelf.api.db.dao.link.BookPublisherLinkDAO;
import net.kelsier.bookshelf.api.db.dao.link.BookRatingLinkDAO;
import net.kelsier.bookshelf.api.db.dao.link.BookSeriesLinkDAO;
import net.kelsier.bookshelf.api.db.dao.link.BookTagLinkDAO;
import net.kelsier.bookshelf.api.db.dao.metadata.CommentDAO;
import net.kelsier.bookshelf.api.db.dao.customcolumn.CustomColumnDAO;
import net.kelsier.bookshelf.api.db.dao.link.CustomColumnLinkDAO;
import net.kelsier.bookshelf.api.db.dao.customcolumn.CustomColumnsDAO;
import net.kelsier.bookshelf.api.db.dao.metadata.DataDAO;
import net.kelsier.bookshelf.api.db.dao.metadata.IdentifierDAO;
import net.kelsier.bookshelf.api.db.dao.metadata.LanguageDAO;
import net.kelsier.bookshelf.api.db.dao.metadata.PublisherDAO;
import net.kelsier.bookshelf.api.db.dao.metadata.RatingDAO;
import net.kelsier.bookshelf.api.db.dao.metadata.SeriesDAO;
import net.kelsier.bookshelf.api.db.dao.metadata.TagDAO;
...
import net.kelsier.bookshelf.api.db.model.metadata.BookData;
...
import net.kelsier.bookshelf.api.db.model.metadata.Comment;
...
import net.kelsier.bookshelf.api.db.model.metadata.Language;
