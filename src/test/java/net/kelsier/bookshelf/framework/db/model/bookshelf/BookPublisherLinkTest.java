...
class BookPublisherLinkTest {
    ...
    @Test
    void testValid() {
        final BookPublisherLink book = new BookPublisherLink(1, 1, 1);
    ...
    @Test
    void testNullId() {
        final BookPublisherLink book = new BookPublisherLink(null, 1, 1);
    ...
    @Test
    void testZeroId() {
        final BookPublisherLink book = new BookPublisherLink(0, 1, 1);
    ...
    @Test
    void testNullBook() {
        final BookPublisherLink book = new BookPublisherLink(1, null, 1);
    ...
    @Test
    void testZeroBook() {
        final BookPublisherLink book = new BookPublisherLink(1, 0, 1);
    ...
    void testNullPublisher() {
        final BookPublisherLink book = new BookPublisherLink(1, 1, null);
    ...
    void testZeroPublisher() {
        final BookPublisherLink book = new BookPublisherLink(1, 1, 0);
